...
|---|---|---|
| `moneygraph/` | Loading, analytics, rules, configuration and export | `tests/test_rules.py`, `tests/test_outputs.py`, `tests/test_no_hardcode.py` |
| `agent/` | Graph queries, fact cards, citations and optional model integration | `tests/test_store.py`, `tests/test_agent.py` |
| `app/` | Screen rendering, navigation, charts and cached resources | `tests/test_app.py` |
