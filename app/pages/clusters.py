...
store = get_store()
page_header("Find the groups within the graph.", "Inspect connected communities, their role patterns, and the clients that deserve a closer look.")
...
cid = st.selectbox("Choose a cluster", ordered.cluster_id.tolist(),
...
with view:
    ...
    st.caption("Communities use an undirected projection; arrows retain the original transfer direction. Membership is not evidence of a shared purpose.")
with members:
